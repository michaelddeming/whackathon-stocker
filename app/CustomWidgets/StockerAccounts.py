...
class StockerAccounts(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.selected_account_label = ctk.CTkLabel(self.selected_account_information_header, text=f"Selected Account(s): {self.selected_account_name}", fg_color="transparent").grid(row=0, column=0, sticky="w", padx=15,)
        ...
        self.selected_account_total_value_label = ctk.CTkLabel(self.selected_account_information_header, text=f"Total Value: ${self.selected_account_total_value}", fg_color="transparent").grid(row=1, column=0, padx=15, sticky="w")
        
        # SELECETED ACCOUNT INFORMATION HEADER | SELECTED ACCOUNT CASH RESERVE LABEL: "Cash Reserve"
        self.selected_account_cash = 500.00
        self.selected_account_cash_label = ctk.CTkLabel(self.selected_account_information_header, text=f"Cash Reserve: ${self.selected_account_cash}", fg_color="transparent").grid(row=0, column=1)
        
        # SELECETED ACCOUNT INFORMATION HEADER | SELECTED ACCOUNT UPDATE CASH BUTTON: "Update Cash"
        self.selected_account_update_cash_button = ctk.CTkButton(self.selected_account_information_header, text=f"Update Cash").grid(row=1, column=1)
        ...
        self.selected_account_stock_asset_value_label = ctk.CTkLabel(self.selected_account_information_header, text=f"Stock Asset Value: ${self.selected_account_stock_asset_value}", fg_color="transparent").grid(row=0, column=2)
